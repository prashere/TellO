...
#                 reward = self.environment.get_reward(action=action,state=next_state)
...
#                 reward = self.environment.get_reward(state=state, action=action)
#                 trial_reward += reward
...
#     # 'actions' list comes from actions.py
...
#     # Load the previous Q-table if you want to continue from the last training
